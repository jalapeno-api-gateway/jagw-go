...
var file_core_base_proto_rawDesc = []byte{
	...
	0x6d, 0x74, 0x69, 0x64, 0x42, 0x2e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_core_base_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_core_base_proto_goTypes = []interface{}{
...
func file_core_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_core_base_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
